...
const destinations = [
  { id: 1, name: 'Srinagar',  image: img('/images/srinagar.png'),  description: 'Experience the serene Dal Lake and Mughal Gardens.' },
  ...
  { id: 5, name: 'Leh',       image: img('/images/leh.png'),       description: 'Explore the rugged landscapes and monasteries of Leh.' },
  { id: 6, name: 'Yousmarg',  image: img('/images/yousmarg.png'),  description: 'A hidden gem, ideal for a peaceful nature retreat.' },
];
